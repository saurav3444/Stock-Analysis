            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-info">
                  <h4 class="card-title">My Weekly Review</h4>
                  <p class="card-category">From 28/09/20 To 02/10/20</p>
                </div>
                <div class="card-body">
                  <form>
                    <!--<div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label><h3>What went Right For Me</h3></label>
                          <div class="form-group">
                     ...
                     <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label><h3>What went Wrong For Me</h3></label>
                          <div class="form-group">
                           <!-- <label class="bmd-label-floating"> Lamborghini Mercy, Your chick she so thirsty, I'm in that two seat Lambo.</label>-->
                            <textarea class="form-control" rows="3"></textarea>
                          </div>
                     ...
                     <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label><h3>My Learnings</h3></label>
                          <div class="form-group">
                           <!-- <label class="bmd-label-floating"> Lamborghini Mercy, Your chick she so thirsty, I'm in that two seat Lambo.</label>-->
                            <textarea class="form-control" rows="3"></textarea>
                          </div>
