			...
			<nav
				...
				<div class="container-fluid">
					<div class="navbar-wrapper">
						<img src="css/Schlumberger_Logo.jpg" width="250" height="70" alt="Card image cap">
					</div>
				</div>
				</nav>
  ...
  <!-- Indicators -->
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="css/SlbLady.jpg" alt="Los Angeles">
              </div>
              <div class="carousel-item">
                <img src="css/ocean.jpg" alt="Chicago">
              </div>
              <div class="carousel-item">
                <img src="css/drill.webp" alt="New York">
              </div>
            </div>
	...
	<!--  		<div class="content">
				<div class="container-fluid">
                  ...
                  <div class="ct-chart" id="dailySalesChart"></div>
								...
								<img class="card-img-top" src="css/SLB.png" alt="Card image cap">
								<div class="card-body">
									<h4 class="card-title">9/8/2020</h4>
									<h3 class="card-title">Schlumberger, IBM and Red Hat,
										announced today a collaboration to accelerate digital
										transformation across the oil and gas industry.</h3>
                  ...
                  <div class="ct-chart" id="websiteViewsChart"></div>
								...
								<img class="card-img-top" src="css/Lepeuch.jpg"
									alt="Card image cap">
								<div class="card-body">
									<h4 class="card-title">9/8/2020</h4>
									<h3 class="card-title">
										Le Peuch, Chief Executive Officer, Speaks at Barclays CEO
										Energy - Power Conference 2020<br>
										<br>
									</h3>
								...
								<div class="card-footer">
									<div class="stats">
										<i class="material-icons">access_time</i> updated 5 days back
									</div>
								</div>
							</div>
						</div>
                  ...
                  <div class="ct-chart" id="completedTasksChart"></div>
								...
								<img class="card-img-top" src="css/conference.jpg"
									alt="Card image cap">
								<div class="card-body">
									<h4 class="card-title">9/4/2020</h4>
									<h3 class="card-title">
										Schlumberger Announces Second Quarter 2020 Results Conference
										Call <br>
										<br>
										<br>
									</h3>
           ...
           <div class="col-md-6">
              ...
              <div class="flip-card-inner">
                <div class="flip-card-front">
                  <img src="css/aboutus.jpg" alt="Avatar" width="700" height="400" >
                  <div class="centered"><h2><b>About Us</b></h2></div>
                </div>
                <div class="flip-card-back">
                  
                  <br>
                  <h3><p> SLB is the leading provider of technology and services to the energy industry across the world. It specializes in reservoir characterization, drilling, production, and processing and offer the most comprehensive range of products and services in the industry.</p></h3>
            ...
            <div class="flip-card">
              <div class="flip-card-inner">
                <div class="flip-card-front">
                  <img src="css/slbcommunity.jpg" alt="Avatar" width="700" height="400" >
                  <div class="centered"><h2><b>SLB Community Initiatives</b></h2></div>
                </div>
                <div class="flip-card-back">
                  
                  <br>
                  <h3><p> In Sumatra, where a local school lacked an adequate number of trash bins, Schlumberger employees modified an empty plastic drum and turned it into a trash bin for use in the school</p></h3>
